...
public class Matrices { //Creamos la clase con sus correspondientes constructores
    ...
    public Matrices lectura() throws MiExcepcion, IOException {
        Matrices nueva = new Matrices();
        int dim, c=0;
        int[][] comp;
        String entrada;
            ...
            nueva = new Matrices(comp);
        return nueva;
        }
    //lectura del teclado


    public String toString(Matrices a) {
        String texto = "";
    ...
    public Matrices suma(Matrices a, Matrices b) throws MiExcepcion{
        Matrices resultado = new Matrices(a.dimension);
        for (int i = 0; i <= a.dimension; i++) {
            for (int j = 0; j <= a.dimension; j++) {
    ...
    public Matrices suma(Matrices a)throws MiExcepcion {
        Matrices resultado = new Matrices(a.dimension);
        for (int i = 0; i <= a.dimension; i++) {
            for (int j = 0; j <= a.dimension; j++) {
    ...
    public Matrices resta(Matrices a, Matrices b) throws MiExcepcion{
        Matrices resultado = new Matrices(a.dimension);
        for (int i = 0; i <= a.dimension; i++) {
            for (int j = 0; j <= a.dimension; j++) {
                resultado.componentes[i][j] = (a.componentes[i][j] - b.componentes[i][j]);
    ...
    public Matrices resta(Matrices a) throws MiExcepcion {
        Matrices resultado = new Matrices(a.dimension);
        for (int i = 0; i <= a.dimension; i++) {
            for (int j = 0; j <= a.dimension; j++) {
    ...
    public Matrices cambio_de_signo() {
        Matrices resultado = new Matrices(this.dimension);
        for (int i = 0; i <= this.dimension; i++) {
            for (int j = 0; j <= this.dimension; j++) {
    ...
    public Matrices producto(Matrices a, Matrices b) throws MiExcepcion{
        Matrices resultado = new Matrices(a.dimension);
        int j=0;
        int r =0;
        for (int i = 0; i <= a.dimension; i++) {
    ...
    public Matrices producto(Matrices a) {
        Matrices resultado = new Matrices(a.dimension);
        for (int i = 0; i <= a.dimension; i++) {
            for (int j = 0; j <= a.dimension; j++) {
                resultado.componentes[i][j] = 0;
    ...
    public Matrices producto_constante(Matrices a, int b) {
        Matrices resultado = new Matrices(a.dimension);
        for (int i = 0; i <= a.dimension; i++) {
            for (int j = 0; j <= a.dimension; j++) {
    ...
    public Matrices traspuesta(Matrices a) {
        Matrices resultado = new Matrices(a.dimension);
        for (int i = 0; i <= a.dimension; i++) {
            for (int j = 0; j <= a.dimension; j++) {
