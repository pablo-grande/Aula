...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void ButtonBajaCursoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonBajaCursoMouseClicked
        ...
        if(isNumeric(codigo)){
            ...
            Gestor.BaixaCurs(Integer.parseInt(codigo));
        } else {
    ...
    private void AltaAsignaturaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AltaAsignaturaMouseClicked
        ...
        if(codigoFalse||codigoUltimoCurso!=-1){
            ...
            Assignatura asign = new Assignatura(nombre, cod);
            llistaCursos.get(numCursos).getListaAss().add(asign);
        }else{
            JOptionPane.showMessageDialog(null, "Ha introducido un código incorrecto, por favor inténtelo de nuevo");
        }
            ...
            if (cod > 0) {
                ...
                if (numCursos != 0) {
                    for (int i = 0; i < numCursos; i++) {
                        if (Integer.parseInt(codigo) == Gestor.llistaCursos.get(i).getCodiCurs()) {
                            existe = true;
                            break;
                        }
                    }
                ...
                if (!existe) {
                    ...
                    Curs curs = new Curs(nombre, codigoUltimoCurso);
                    Gestor.llistaCursos.add(curs);
                    System.out.println(Gestor.llistaCursos.printCursCod(numCursos));
                } else {
                    numCursos--;
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        String lista = "";
        if (isNumeric(codigo)) {
            if (Gestor.llistaCursos.size()!=0) {
                lista = lista + Gestor.LlistarCursiAlumnes(Integer.parseInt(codigo));
                if (lista != "") {
                ...
                JOptionPane.showMessageDialog(null, "Aún no ha dado de alta ningún curso ni asignatura.");
            }
        } else {
            JOptionPane.showMessageDialog(null, "Ha introducido un código incorrecto, por favor inténtelo de nuevo");
        }
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        ...
        if(isNumeric(codAss)&&isNumeric(codAlu)){
            ...
            int a = Gestor.CercaCursAssignatura(cod);
            if(b!=-1){
                Gestor.AltaAlumne(nomAlu, Integer.parseInt(codAlu), cod);
            } else {
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        if(isNumeric(codigo)){
            if(Gestor.llistaCursos.size()!=0){
                lista=lista+Gestor.LlistarCursiAssignatures(Integer.parseInt(codigo));
                if(lista!=""){
